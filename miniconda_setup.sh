...
if [[ "$USER" == "sucho" ]]; then
	conda create --name 42AI-$USER python=3.7 jupyter pandas pycodestyle numpy scikit-learn -y
else
	conda create --name 42AI-sucho python=3.7 jupyter pandas pycodestyle numpy scikit-learn -y
fi
