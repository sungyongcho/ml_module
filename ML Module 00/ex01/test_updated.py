...
if __name__ == "__main__":
    ...
    assert abs(tstat.percentile(data, 10) -
               np.percentile(data, 10)) < epsilon, err
    assert abs(tstat.percentile(data, 28) -
               np.percentile(data, 28)) < epsilon, err
    assert abs(tstat.percentile(data, 83) -
               np.percentile(data, 83)) < epsilon, err
